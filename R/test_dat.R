#' A sample test data set used for examples
#'
#' This test data set with a cure fraction contains 500 patients' time-to-event outcomes, baseline information (X1 and X2),
